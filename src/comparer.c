...
int main(int argc, char **argv){
    ...
    struct MY_BMP_HEADER* bmp_header1 = (struct MY_BMP_HEADER*)malloc(sizeof(struct MY_BMP_HEADER));
    struct MY_BMP_HEADER* bmp_header2 = (struct MY_BMP_HEADER*)malloc(sizeof(struct MY_BMP_HEADER));
